          ...
          <div className="content">
            <div className="coverPage">
                  ...
                  <nav>
                    <ul className="navBar-ul">
                      <li className="navBar-li">
                        <a className="navBar-link" href="#service">服务</a>
                      </li>
                      <li className="navBar-li">
                        <a className="navBar-link" href="#team">团队</a>
                      </li>
                      <li className="navBar-li">
                        <a className="navBar-link" href="#client">客户</a>
                      </li>
                    </ul>
                  </nav>
              ...
              <div className="thoseWords">
                <p className="slogan">开启楼宇5G<br></br>应用智能化时代</p>
              </div>
            ...
            <div className="info">
              ...
              <div className="service">
                ...
                <h2 id="title1">核心业务</h2>
                <div className="magic">
                <div className="magic-menu1">
                    <ul className="magic-ul">
                      <li className="magic-title">智能化办公</li>
                      <li id="g5" className="magic-li">云服务器/专线接入</li>
                      <li className="magic-li">宽带售后服务</li>
                      <li className="magic-li">访客管理/人脸识别</li>
                    </ul>
                  ...
                  <div className="magic-menu2">
                    <ul className="magic-ul">
                      <li className="magic-title">智能化楼宇</li>
                      <li id="g5" className="magic-li">宽带接入(4G/5G)</li>
                      <li className="magic-li">5G+应用(mec边缘云计算+xr/ar)/智慧停车/招商服务</li>
                    </ul>
                  </div>
                  ...
                  <div className="magic-menu3">
                    <ul className="magic-ul">
                      <li className="magic-title">智能化园区</li>
                      <li className="magic-li">智能安防/物业管理</li>
                      <li className="magic-li">人员管控/全景监控/信息发布</li>
                    </ul>
                  </div>
              ...
              <div className="teaminfo">
                <h2 id="title1">我们的团队</h2>
                <div className="teamwrapper">
                  <div className="teamContent1">
                    <div className="nameCard">
                      <div className="nameCardC">
                        <div className="nameCardCC">
                         <p className="nameCardInfo">汤敬华</p>
                         <p id="lastName" className="nameCardInfo"></p>
                        </div>
                      </div>                     
                    </div>
                    <div className="nameCard">
                      <p className="nameCardInfo">陈祚君</p>
                      <p id="lastName" className="nameCardInfo"></p>
                    </div>
                    <div className="nameCard">
              ...
              <div className="contact">
                ...
                <div className="contactInfo">
                  ...
                  <div className="contactInfoD">
                    ...
                    <p className="footerinfo" id="contactStyle">
                    &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;上海市黄浦区湖滨路222号企业天地1号15楼&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<br/>
                    </p>
                  </div>
                  <div id="contactInfoD">
              ...
              <div className="footer">
                ...
                <section id="footerSection">
                  <h5 className="footerTitle" id="footerStyle">地址</h5>
                ...
                <section id="footerSection">
                  <h5 className="footerTitle" id="footerStyle">联系方式</h5>
                  <p className="footerinfo" id="footerStyle">
                    邮箱: service@smartspace.ltd<br />
                    咨询热线：400-117-1204<br />
                    微信号: SmartSpace 讯楼<br />
                    微信公众号：SmartSpace讯楼科技
                  </p>
                </section>
              </div>
